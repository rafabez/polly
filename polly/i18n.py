...
TRANSLATIONS = {
    "en": {
        ...
        "vision.not_found": "Image not found: {path}",
        "vision.model_switch": "Switching to vision model: {model}",
        "vision.capturing": "Capturing screenshot…",
        "vision.capture_failed": "Screenshot capture failed. Provide an image path instead.",
        "vision.no_prompt": "Provide a question or prompt about the image.",
        "info.see": "Describe or reason about an image or screenshot",
        "rollback.none": "No transactions to undo.",
        "rollback.done": "Undo complete.",
        "rollback.partial": "Undo finished with some errors (see above).",
        "rollback.list_header": "Recent agent transactions:",
        "rollback.list_empty": "No agent transactions recorded yet.",
        "info.undo_last": "Undo the last agent task (reverse file changes)",
        "info.transactions": "List recent agent transactions",
        "agent.undo_tip": "Tip: run polly --undo-last to reverse these changes.",
    ...
    "pt": {
        ...
        "vision.not_found": "Imagem não encontrada: {path}",
        "vision.model_switch": "Trocando para modelo com visão: {model}",
        "vision.capturing": "Capturando tela…",
        "vision.capture_failed": "Falha ao capturar tela. Forneça um caminho de imagem.",
        "vision.no_prompt": "Forneça uma pergunta ou prompt sobre a imagem.",
        "info.see": "Descreve ou raciocina sobre uma imagem ou captura de tela",
        "rollback.none": "Nenhuma transação para desfazer.",
        "rollback.done": "Desfazer concluído.",
        "rollback.partial": "Desfazer concluído com alguns erros (veja acima).",
        "rollback.list_header": "Transações recentes do agente:",
        "rollback.list_empty": "Nenhuma transação de agente registrada ainda.",
        "info.undo_last": "Desfaz a última tarefa do agente (reverte arquivos)",
        "info.transactions": "Lista transações recentes do agente",
        "agent.undo_tip": "Dica: rode polly --undo-last para reverter essas mudanças.",
