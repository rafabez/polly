...
TRANSLATIONS = {
    "en": {
        ...
        "info.history": "Print recent conversation history",
        "info.history_clear": "Clear the conversation history log",
        "info.purge": "Wipe ALL local Polly state (with confirmation)",
        "info.update": "Update Polly to the latest version from GitHub",
        "info.rescan": "Rescan and refresh system context (OS, shell, tools)",
        "info.show_system": "Show detected system information",
        "agent.disabled": "Agent mode is disabled. Enable with: polly --enable-agent (or set agent_enabled=true in config).",
        "agent.starting": "Starting agent for: {goal}",
        "agent.step": "Step {step}/{total} — calling tools…",
        "agent.done": "Task complete.",
        "agent.aborted": "Agent aborted.",
        "agent.api_error": "Agent API error",
        "agent.max_steps": "Reached step limit ({n}). The agent may not have finished.",
        "info.agent": "Run in agent mode: plan + execute multi-step tasks with tools",
        "info.enable_agent": "Enable agent mode (saved to config)",
        "msg.agent_enabled": "Agent mode enabled. Use polly --agent \"your goal\".",
        "msg.provider_no_models": "No models found from provider '{provider}'. Is it running?",
        "param.provider": "Provider type: pollinations (default), ollama, openai, lmstudio, custom",
        "param.base_url": "Custom OpenAI-compatible base URL",
        "param.api_key": "API key / Bearer token for the provider",
        "info.skill": "Run an OS skill (use --list-skills to see available)",
        "info.list_skills": "List available OS skills",
        "msg.skill_not_found": "Skill not found: '{name}'. Use --list-skills to see available.",
        "msg.skill_no_commands": "Skill '{name}' returned no commands for that task.",
        "msg.skills_header": "Available OS skills:",
        "edit.not_found": "File not found: {path}",
        "edit.too_big": "{path} is {size} (limit: {limit}). Use a text editor for large files.",
        "edit.read_error": "Cannot read file: {error}",
        "edit.api_error": "Model error: {error}",
        "edit.thinking": "Generating edit…",
        "edit.no_changes": "No changes suggested.",
        "edit.dry_run": "[dry-run] Would write: {path}",
        "edit.backup_saved": "Backup: {path}",
        "edit.written": "Written: {path}",
        "edit.write_error": "Write error: {error}",
        "edit.no_backup": "No backup found for: {path}",
        "edit.reverted": "Reverted {path} from {backup}",
        "info.edit": "Edit a file with a plain-language instruction",
        "info.revert": "Revert a file to its most recent backup",
        "exec.running": "Running: {cmd}",
        "exec.exit_code": "Exit code: {code}",
        "exec.dry_run": "[dry-run] Would run ({risk}): {cmd}",
        "exec.disabled": "Execution is disabled. Set execute_enabled=true in config.",
        "exec.interrupted": "Execution interrupted.",
        "exec.failed": "Execution failed",
        "exec.pick_prompt": "Multiple commands generated. Choose one to execute:",
        "exec.pick_choice": "Enter number (1-{n}) or 'q' to cancel: ",
        "info.execute": "Generate and execute a command (with confirmation)",
        "info.dry_run": "Show the command without executing it",
        "safety.blocked": "Blocked for safety: {reason}",
        "safety.confirm_safe": "Run: {cmd}\nProceed? [y/N] ",
        "safety.confirm_caution": "Run: {cmd}\nThis may change your system. Proceed? [y/N] ",
        "safety.confirm_destructive": "Run: {cmd}\nWARNING: this is destructive and may be irreversible.\nType {word} to proceed: ",
        "safety.aborted": "Execution aborted.",
        "msg.system_rescanned": "System context refreshed.",
        "msg.system_header": "System context:",
        "msg.system_none": "No system context available. Run polly --rescan.",
        "info.version": "Show version number",
        "msg.updating": "Updating Polly from GitHub…",
        "msg.update_done": "Polly updated successfully.",
        "msg.update_failed": "Update failed. Check your internet connection.",
        "msg.update_no_pipx": "pipx not found. Update manually: {cmd}",
        ...
        "msg.history_empty": "No conversation history yet.",
        "msg.history_cleared": "Conversation history cleared.",
        "msg.purge_confirm": "Type 'yes' to wipe ALL local Polly state (memory, history, caches): ",
        "msg.purge_done": "Local state wiped: {summary}",
        "msg.purge_aborted": "Purge aborted.",
        "msg.you": "You:",
        "msg.polly": "Polly:",
    ...
    "pt": {
        ...
        "info.history": "Exibe o histórico recente de conversas",
        "info.history_clear": "Limpa o log de histórico de conversas",
        "info.purge": "Apaga TODO o estado local do Polly (com confirmação)",
        "info.update": "Atualiza o Polly para a última versão do GitHub",
        "info.rescan": "Re-escaneia e atualiza o contexto do sistema (OS, shell, ferramentas)",
        "info.show_system": "Mostra informações detectadas do sistema",
        "agent.disabled": "Modo agente desabilitado. Ative com: polly --enable-agent (ou agent_enabled=true no config).",
        "agent.starting": "Iniciando agente para: {goal}",
        "agent.step": "Passo {step}/{total} — chamando ferramentas…",
        "agent.done": "Tarefa concluída.",
        "agent.aborted": "Agente cancelado.",
        "agent.api_error": "Erro de API no agente",
        "agent.max_steps": "Limite de passos atingido ({n}). O agente pode não ter terminado.",
        "info.agent": "Modo agente: planeja e executa tarefas em múltiplos passos com ferramentas",
        "info.enable_agent": "Habilita o modo agente (salva no config)",
        "msg.agent_enabled": "Modo agente habilitado. Use polly --agent \"seu objetivo\".",
        "msg.provider_no_models": "Nenhum modelo encontrado do provider '{provider}'. Ele está rodando?",
        "param.provider": "Tipo de provider: pollinations (padrão), ollama, openai, lmstudio, custom",
        "param.base_url": "URL base compatível com OpenAI",
        "param.api_key": "Chave de API / Bearer token para o provider",
        "info.skill": "Executar um skill de OS (use --list-skills para ver disponíveis)",
        "info.list_skills": "Listar os skills de OS disponíveis",
        "msg.skill_not_found": "Skill não encontrado: '{name}'. Use --list-skills para ver disponíveis.",
        "msg.skill_no_commands": "Skill '{name}' não retornou comandos para essa tarefa.",
        "msg.skills_header": "Skills de OS disponíveis:",
        "edit.not_found": "Arquivo não encontrado: {path}",
        "edit.too_big": "{path} tem {size} (limite: {limit}). Use um editor de texto para arquivos grandes.",
        "edit.read_error": "Não foi possível ler o arquivo: {error}",
        "edit.api_error": "Erro no modelo: {error}",
        "edit.thinking": "Gerando edição…",
        "edit.no_changes": "Sem alterações sugeridas.",
        "edit.dry_run": "[simulação] Escreveria: {path}",
        "edit.backup_saved": "Backup: {path}",
        "edit.written": "Escrito: {path}",
        "edit.write_error": "Erro ao escrever: {error}",
        "edit.no_backup": "Nenhum backup encontrado para: {path}",
        "edit.reverted": "{path} revertido de {backup}",
        "info.edit": "Edita um arquivo com uma instrução em linguagem natural",
        "info.revert": "Reverte um arquivo para o backup mais recente",
        "exec.running": "Executando: {cmd}",
        "exec.exit_code": "Código de saída: {code}",
        "exec.dry_run": "[simulação] Executaria ({risk}): {cmd}",
        "exec.disabled": "Execução desabilitada. Configure execute_enabled=true.",
        "exec.interrupted": "Execução interrompida.",
        "exec.failed": "Falha na execução",
        "exec.pick_prompt": "Múltiplos comandos gerados. Escolha um para executar:",
        "exec.pick_choice": "Digite o número (1-{n}) ou 'q' para cancelar: ",
        "info.execute": "Gera e executa um comando (com confirmação)",
        "info.dry_run": "Mostra o comando sem executá-lo",
        "safety.blocked": "Bloqueado por segurança: {reason}",
        "safety.confirm_safe": "Executar: {cmd}\nContinuar? [s/N] ",
        "safety.confirm_caution": "Executar: {cmd}\nIsso pode alterar seu sistema. Continuar? [s/N] ",
        "safety.confirm_destructive": "Executar: {cmd}\nAVISO: isso é destrutivo e pode ser irreversível.\nDigite {word} para continuar: ",
        "safety.aborted": "Execução cancelada.",
        "msg.system_rescanned": "Contexto do sistema atualizado.",
        "msg.system_header": "Contexto do sistema:",
        "msg.system_none": "Sem contexto do sistema. Rode polly --rescan.",
        "info.version": "Mostra número da versão",
        "msg.updating": "Atualizando o Polly pelo GitHub…",
        "msg.update_done": "Polly atualizado com sucesso.",
        "msg.update_failed": "Falha na atualização. Verifique sua conexão.",
        "msg.update_no_pipx": "pipx não encontrado. Atualize manualmente: {cmd}",
        ...
        "msg.history_empty": "Nenhum histórico de conversa ainda.",
        "msg.history_cleared": "Histórico de conversa limpo.",
        "msg.purge_confirm": "Digite 'yes' para apagar TODO o estado local do Polly (memória, histórico, caches): ",
        "msg.purge_done": "Estado local apagado: {summary}",
        "msg.purge_aborted": "Limpeza cancelada.",
        "msg.you": "Você:",
        "msg.polly": "Polly:",
