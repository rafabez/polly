...
def read_pdf(file_path: str) -> Optional[str]:
    ...
    if not PDF_READ_AVAILABLE:
        console.print("[yellow]Warning: pypdf not installed. Install with: pip install pypdf[/yellow]")
        return None
    ...
    try:
        ...
        if not text_parts:
            console.print("[yellow]Warning: No text could be extracted from PDF[/yellow]")
            return None
...
def write_pdf(content: str, output_path: str, title: str = "Polly Output") -> bool:
    ...
    if not PDF_WRITE_AVAILABLE:
        console.print("[yellow]Warning: reportlab not installed. Install with: pip install reportlab[/yellow]")
        return False
    ...
    try:
        ...
        console.print(f"[green]✓ PDF saved to: {output_path}[/green]")
        return True
        
    except Exception as e:
        console.print(f"[red]Error writing PDF: {e}[/red]")
        return False
